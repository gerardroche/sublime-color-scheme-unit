...
* Added [#19](https://github.com/gerardroche/sublime-color-scheme-unit/issues/19): Support for `*.sublime-color-scheme` color schemes

### Changed

* Changed: Renamed "ColorSchemeUnit: Insert Assertions" → "ColorSchemeUnit: Generate Assertions"
* Changed: Renamed "ColorSchemeUnit: Show Scope and Colors" → "ColorSchemeUnit: Show Styles"

### Removed

* Removed "ColorSchemeUnit: Insert Syntax Assertions" to its own package
